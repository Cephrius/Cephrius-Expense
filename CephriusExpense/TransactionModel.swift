...
extension Category {
    ...
    static let publicTransportation = Category(id: 101, name: "Public Transportation", icon: .taxi, mainCategoryId: 1)
    static let taxi = Category(id: 102, name: "Taxi", icon: .taxi, mainCategoryId: 1)
    static let mobilePhone = Category(id: 102, name: "Mobile Phone", icon: .mobile_alt, mainCategoryId: 1)
    static let moviesAndDVDs = Category(id: 201, name: "Movies & DVDs", icon: .film, mainCategoryId: 2)
    static let bankFees = Category(id: 301, name: "Bank Fees", icon: .hand_holding_usd, mainCategoryId: 3)
    static let financeCharge = Category(id: 401, name: "Finance Charge", icon: .hand_holding_usd, mainCategoryId: 4)
